...
def main():
    ...
    for line in lines:
        ...
        if date_obj.month not in all_values_dict[date_obj.year]:
            # TODO change month name from int to str
            all_values_dict[date_obj.year][date_obj.month] = {}
        all_values_dict[date_obj.year][date_obj.month][counter] = {
            "name": name,
